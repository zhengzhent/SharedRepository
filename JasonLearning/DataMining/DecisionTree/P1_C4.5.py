...
path = "C:\\Users\\zheng_dpjpzv5\\Desktop\\实验6 决策树\\weather_nominal.csv"
...
labels = [u'outlook_isSunny', u'outlook_isRanny', u'outlook_isOvercast', u'temperature_is1', u'temperature_isMild',
          u'temperature_isCool', u'humidity', u'windy', u'play']
...
for i in range(X_test.shape[0]):
    datatest = X_test.iloc[i]
    # print(datatest.values)
    predict = dt.predict(datatest.values)
    truth = y_test.iloc[i]
    print(predict,truth)