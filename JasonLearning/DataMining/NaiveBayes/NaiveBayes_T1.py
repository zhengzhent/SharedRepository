...
# 数据读入
path = "C:\\Users\\zheng_dpjpzv5\\Desktop\\实验4 朴素贝叶斯网络\\cancer_X.csv"
dataX = pd.read_csv(path, header=None)
path = "C:\\Users\\zheng_dpjpzv5\\Desktop\\实验4 朴素贝叶斯网络\\cancer_y.csv"
...
# rowy = datay.shape[0]
# print(rowX,rowy)
X_train, X_test, y_train, y_test = train_test_split(dataX, datay, test_size=0.3,random_state=10)
# print(X_train)
# print(X_test)
